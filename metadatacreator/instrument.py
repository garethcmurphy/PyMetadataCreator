...
class Nmx(Instrument):
    def __init__(self):
        ...
        self.scientificMetadata = {
            ...
            'Collimator (Material (w x h) B4C': '10x20',
            'Collimator (Material (w x h) AlBO3 2': '10x20',
            'Collimator (Material (w x h) B4C 2': '10x20',
            'Collimator (Material (w x h) B4C 3': '10x20',
            'Collimator (Material (w x h) B4C sum': '10x20',
            'Mask': '10x20',
            'MCA': '60',
            'He3': '60',
            'Run number': '60',
