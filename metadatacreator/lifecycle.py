class LifeCycle:
    def __init__(self):
        ...
        self.ownerGroup = "string",
        self.accessGroups = ["string"]
        self.createdBy = "string"
        self.updatedBy = "string"
        self.datasetId = "string"
        self.rawDatasetId = "string"
        self.derivedDatasetId = "string"
        self.createdAt = "2018-09-06T09:53:58.370Z"
        self.updatedAt = "2018-09-06T09:53:58.370Z"
