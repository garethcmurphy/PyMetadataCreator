class MultibladeMetadata:
    metadata_object = {
        ...
        '0017': {'tag': '03_8_E_Ir_slit', 'comment': 'xxx'},
        '0018': {'tag': '03_9_E_Ir_test', 'comment': 'xxx'},
        '0019': {'tag': '03N_12_G_plexi', 'comment': 'xxx'},
        '0020': {
            'tag': '04_10_I2_Si_divergent', 'comment': 'xxx'},
        '0021': {'tag': '04_11_L_FeSi_test', 'comment': 'xxx'},
        '0022': {'tag': '04_1_E_Ir_test', 'comment': 'xxx'},
        '0023': {
            'tag': '04_2_E1_Ir_collimated', 'comment': 'xxx'},
        '0024': {'tag': '04_3_H_Si_test', 'comment': 'xxx'},
        '0025': {'tag': '04_4_H_Si_collimated', 'comment': 'xxx'},
        '0026': {
            'tag': '04_5_H1_Si_collimated_HVtests', 'comment': 'xxx'},
        '0027': {'tag': '04_6_I_FeSi_test', 'comment': 'xxx'},
        '0028': {
            'tag': '04_7_I_FeSi_divergent',
            'comment': 'sample supermirror divergent'},
        '0029': {
            'tag': '04_8_I1_FeSi_divergent_magnet', 'comment': 'xxx'},
        '0030': {
            'tag': '04_9_I2_Si_divergent_test', 'comment': 'xxx'},
        '0031': {
